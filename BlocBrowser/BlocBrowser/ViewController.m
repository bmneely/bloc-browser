...
- (void)viewDidLoad {
    ...
    UIAlertController *alert = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Welcome", @"Welcome") message:NSLocalizedString(@"Welcome to Bloc Browser!", @"Welcome to Bloc Browser!") preferredStyle:UIAlertControllerStyleAlert];
